...
# ====================== 多区域配置加载 (核心改造) ======================
    # 配置路径（可根据需要改为命令行参数）
    JSON_PATH = r"/root/autodl-tmp/Octree-GS/Octree-GS/data/Ma0422/cameras.json"

    REGIONS_JSON_PATH = r"/root/autodl-tmp/Octree-GS/Octree-GS/data/Ma0422/regions_config.json"  # 多区域配置文件
    CACHE_JSON_PAH = r"/root/autodl-tmp/Octree-GS/Octree-GS/data/Ma0422/cache.json"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--save_iterations", nargs="+", type=int, default=[i * 60000 for i in range(1, 65 + 1)])
